...
public class ImageAnnotator implements StepExecutionListener, Tasklet {
	...
	private List<Long> getAssociatedGeneraIds(Long resourceId) {
		String query = "SELECT t.id "
				...
				+ "WHERE t.family = a.family AND t.scientificName = a.genus ";
		return jdbcTemplate.queryForList(query, ImmutableMap.<String, Long>of("resourceId", resourceId), Long.class);
	}

	@Override
	public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
		Map<String, ? extends Object> queryParameters = ImmutableMap.<String, Object>builder()
				.put("authorityId", getAuthorityId())
				.put("resourceId", resourceId)
				.put("jobId", stepExecution.getJobExecutionId())
				.build();
